...
- (void)initSubviews
{
    ...
    [self.faceBtn setTitleColor:AuxiliaryColor forState:UIControlStateDisabled];
    [self.faceBtn setTitleColor:MainColor forState:UIControlStateNormal];
...
- (void)setbarSubViewsFrame
{
    ...
    self.textView.frame = CGRectMake(textViewX, TextViewVerticalOffset, textViewW - mainSpacing, self.textView.frame.size.height);

...
//								constrainedToSize:maxSize lineBreakMode:detailsLabel.lineBreakMode];
    NSDictionary *attriDict = @{NSFontAttributeName: detailsLabel.font};
    CGSize detailsLabelSize = [detailsLabel.text boundingRectWithSize:maxSize options:NSStringDrawingTruncatesLastVisibleLine | NSStringDrawingUsesLineFragmentOrigin | NSStringDrawingUsesFontLeading attributes:attriDict context:nil].size;

...
- (void)invalidateAppearanceForCell:(FSCalendarCell *)cell
{
    ...
    if(cell.preferredFillDefaultColor){
        
        cell.preferredTitleDefaultColor=[UIColor  whiteColor];
        
        
        NSString *temp =[NSDate stringFromDate:[NSDate date] withFormat:@"YYYY-MM-d"];
        
        NSString *tempX =[NSDate stringFromDate:cell.date withFormat:@"YYYY-MM-d"];
        
        if ([tempX isEqualToString:temp]) {
            cell.preferredTitleDefaultColor = GreenColor;
        }
    }

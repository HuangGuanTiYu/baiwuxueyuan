                 ...
                 fromRect:(CGRect)fromRect
{
    ...
    const CGFloat rectXM = fromRect.origin.x + fromRect.size.width * 0.25f;
    const CGFloat rectY0 = fromRect.origin.y;
    const CGFloat rectY1 = fromRect.origin.y + fromRect.size.height;
    const CGFloat rectYM = fromRect.origin.y + fromRect.size.height * 0.25f;;
    
    const CGFloat widthPlusArrow = contentSize.width + kArrowSize;
    const CGFloat heightPlusArrow = contentSize.height + kArrowSize;
    const CGFloat widthHalf = contentSize.width * 0.25f;
    const CGFloat heightHalf = contentSize.height * 0.25f;
    
    const CGFloat kMargin = 5.f;  //＝＝＝＝＝＝＝＝＝＝＝＝＝＝＝＝间距
             ...
             menuItems:(NSArray *)menuItems
{
    ...
    _contentView.layer.borderColor = [UIColor colorWithRed:225/255.0f green:225/255.0f  blue:225/255.0f  alpha:1].CGColor;
...
- (UIView *) mkContentView
{
    ...
    const CGFloat kMinMenuItemWidth = 143.f;
    const CGFloat kMarginX = 14.f;
    const CGFloat kMarginY = 0.f;
    
    UIFont *titleFont = [KxMenu titleFont];
    
    //===========================第一次字体大小===================================
    if (!titleFont) titleFont = [UIFont systemFontOfSize:15];
...
//            button.autoresizingMask = UIViewAutoresizingNone;
        ...
        if (menuItem.title.length) {
            ...
            UILabel *linelable=[[UILabel alloc]initWithFrame:CGRectMake(5, kMarginY, maxItemWidth-10, 1)];
            linelable.backgroundColor=RGBCOLOR(240, 240, 240);
            [itemView addSubview:linelable];
             ...
             inContext:(CGContextRef) context
{
    ...
    // UIColor *tintColor = [UIColor colorWithHexString:@"0195FF" alpha:1.0f];//我注的(*^__^*) 嘻嘻……
    UIColor *tintColor = [UIColor whiteColor ];//在这个地方改变显示的背景色(*^__^*) 嘻嘻……
    if (tintColor) {
    ...
    //====================================================
    const CGFloat kEmbedFix = 6.0f;//字体大小
    ...
    [borderPath fill];
//    [[UIColor redColor] setStroke];   //设置线的颜色
